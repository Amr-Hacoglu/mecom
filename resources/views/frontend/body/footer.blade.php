                    ...
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            <div class="newsletter-content">
                                ...
                                <p class="mb-45">Start You'r Daily Shopping with <span class="text-brand">name of the store</span></p>
                            </div>
                            <img src="{{ asset('frontend/assets/imgs/banner/Fashion_slider_3.png') }}" alt="newsletter" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo ) }}" alt="logo" /></a>
                                <p class="font-lg text-heading">Kitapaty store website Ecommerce</p>
                            </div>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; Made by <strong class="text-brand">Ecommerce</strong> - {{ $setting->copyright }}</p>
                </div>
