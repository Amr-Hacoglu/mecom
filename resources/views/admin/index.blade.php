                ...
                <div class="page-content">
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
							...
							<div class="card radius-10 bg-gradient-deepblue">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $today }} TL</h5>
									<div class="ms-auto">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $month }} TL</h5>
									<div class="ms-auto">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $year }} TL</h5>
									<div class="ms-auto">
								...
								<div class="d-flex align-items-center text-white">
									<h5 class="mb-0 text-white">5630</h5><p class="mb-0">Yearly Sale</p>
