  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Kitapaty</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Kitapaty-tr Book Store
               Email:support@Kitapaty-tr.com <br>
               Mob: 1245454545 <br>
               Istanbul / Kartal:#4 <br>
    ...
    <tbody>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        ...
        <td align="center">{{ $item->price }} TL</td>
      </tr>
      @endforeach
    </tbody>
  </table>
