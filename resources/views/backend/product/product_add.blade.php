           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
			  ...
			  <div class="mb-3">
				...
				<input type="text" name="product_color" class="form-control visually-hidden" data-role="tagsinput" value="Red,Blue,Black"><!-- those are the tages that appear as blue color -->
			  </div>
